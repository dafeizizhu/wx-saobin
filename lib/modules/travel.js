...
class Travel extends Component {
  ...
  render() {
    ...
    const { vehicle_1_id, vehicle_2_id, vehicle_1_brand, vehicle_2_brand, vehicle_1_model, vehicle_2_model } = this.props.app.state.user

    if (!vehicle_1_id) return <div>Loading...</div>
