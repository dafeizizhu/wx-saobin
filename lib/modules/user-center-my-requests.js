...
import { beginChangeDeparture } from '../actions/routes/user-center-my-requests-departure'
import { beginChangeDestination } from '../actions/routes/user-center-my-requests-destination'
import {
  changePassengerNum,
  changeDepartureTime,
  changeRemark
...
class UserCenterMyRequests extends Component {
  ...
  handleDepartureNameClick(item) {
    ...
    hashHistory.push('/user-center/my-requests/departure')
  }
  handleDestinationNameClick(item) {
    const { dispatch } = this.props
    dispatch(beginChangeDestination(item))
    hashHistory.push('/user-center/my-requests/destination')
  }
