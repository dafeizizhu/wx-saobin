...
import { fetchSearch, clearTips } from '../actions/routes/request-destination'
import { changeDestination } from '../actions/routes/request'

class RequestDestination extends Component {
  ...
  render() {
    ...
    const { tips } = this.props.app.routes.requestDestination.search
    return (
...
export default connect(state => state)(RequestDestination)
