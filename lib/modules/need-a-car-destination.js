...
import { fetchSearch, clearTips } from '../actions/routes/need-a-car-destination'
import { changeDestination } from '../actions/routes/need-a-car'

class NeedACarDestination extends Component {
  ...
  render() {
    ...
    const { tips } = this.props.app.routes.needACarDestination.search
    return (
...
export default connect(state => state)(NeedACarDestination)
