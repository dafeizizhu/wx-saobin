...
import { fetchSearch, clearTips } from '../actions/routes/need-a-car-departure'
import { changeDeparture } from '../actions/routes/need-a-car'

class NeedACarDeparture extends Component {
  ...
  render() {
    ...
    const { tips } = this.props.app.routes.needACarDeparture.search
    return (
...
export default connect(state => state)(NeedACarDeparture)
