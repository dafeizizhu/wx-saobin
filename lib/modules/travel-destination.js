...
import { fetchSearch, clearTips } from '../actions/routes/travel-destination'
import { changeDestination } from '../actions/routes/travel'

class TravelDestination extends Component {
  ...
  render() {
    ...
    const { tips } = this.props.app.routes.travelDestination.search
    return (
...
export default connect(state => state)(TravelDestination)
