...
import { fetchSearch, clearTips } from '../actions/routes/travel-departure'
import { changeDeparture } from '../actions/routes/travel'

class TravelDeparture extends Component {
  ...
  render() {
    ...
    const { tips } = this.props.app.routes.travelDeparture.search
    return (
...
export default connect(state => state)(TravelDeparture)
