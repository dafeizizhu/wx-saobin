...
import { fetchSearch, clearTips } from '../actions/routes/request-departure'
import { changeDeparture } from '../actions/routes/request'

class RequestDeparture extends Component {
  ...
  render() {
    ...
    const { tips } = this.props.app.routes.requestDeparture.search
    return (
...
export default connect(state => state)(RequestDeparture)
