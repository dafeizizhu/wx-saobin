...
function school(state = '', action) {
  switch(action.type) {
    case RECIEVE_INIT:
      return action.userInfo.school || state
    case LEAVE:
      return ''
    case CHANGE_SCHOOL:
...
function is_driver(state = false, action) {
  switch(action.type) {
    case RECIEVE_INIT:
      return Boolean(Number(action.userInfo.is_driver))
...
function more_vehicle(state = false, action) {
  switch(action.type) {
    case RECIEVE_INIT:
      return Boolean(action.userInfo.vehicle_2_brand)
...
function license_no(state = '', action) {
  switch(action.type) {
    case RECIEVE_INIT:
      return action.userInfo.license_no
...
function license_pic(state = '', action) {
  switch(action.type) {
    case RECIEVE_INIT:
      return action.userInfo.license_pic
...
function nick_name(state = '', action) {
  switch(action.type) {
    case RECIEVE_INIT:
      return action.userInfo.nick_name
...
function enrollment_t(state = '', action) {
  switch(action.type) {
    case RECIEVE_INIT:
      return action.userInfo.enrollment_t || state
...
function vehicle_1_brand(state = '', action) {
  switch(action.type) {
    case RECIEVE_INIT:
      return action.userInfo.vehicle_1_brand
...
function vehicle_1_model(state = '', action) {
  switch(action.type) {
    case RECIEVE_INIT:
      return action.userInfo.vehicle_1_model
...
function vehicle_1_num(state = 0, action) {
  switch(action.type) {
    case RECIEVE_INIT:
      return action.userInfo.vehicle_1_num
...
function vehicle_1_pic(state = '', action) {
  switch(action.type) {
    case RECIEVE_INIT:
      return action.userInfo.vehicle_1_pic
...
function vehicle_2_brand(state = '', action) {
  switch(action.type) {
    case RECIEVE_INIT:
      return action.userInfo.vehicle_2_brand
...
function vehicle_2_model(state = '', action) {
  switch(action.type) {
    case RECIEVE_INIT:
      return action.userInfo.vehicle_2_model
...
function vehicle_2_num(state = 0, action) {
  switch(action.type) {
    case RECIEVE_INIT:
      return action.userInfo.vehicle_2_num
...
function vehicle_2_pic(state = '', action) {
  switch(action.type) {
    case RECIEVE_INIT:
      return action.userInfo.vehicle_2_pic
