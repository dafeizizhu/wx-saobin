const DATA_SOURCE = {
  ...
  //'searchTravel': './fixture/search-travel-empty.json',
  'publishRequest': './fixture/publish-request.json',
  'getUserInfo': './fixture/get-user-info.json',
  'signUp': './fixture/sign-up.json',
  'updatePersonalInfo': './fixture/update-personal-info'
}
...
export function signUp(params, files, cb) {
  params = $.extend({}, {
    school: '',
    name: '',
    nick_name: '',
  ...
  req.open('POST', DATA_SOURCE['signUp'])
  req.send(formData)
}

export function updatePersonalInfo(params, files, cb) {
  params = $.extend({}, {
    user_id: '',
    school: '',
    name: '',
  ...
  req.open('POST', DATA_SOURCE['updatePersonalInfo'])
  req.send(formData)
}

export function getTravelList(params, cb) {
  // TODO
  setTimeout(() => {
    cb({
      error_code: 0,
