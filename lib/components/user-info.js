...
class UserInfo extends Component {
  render() {
    ...
    const fields = {
      ...
      departure_addr: <Cell key='departure_addr' label='出发地'>{info.departure_addr}</Cell>,
      destination_addr: <Cell key='destination_addr' label='目的地'>{info.destination_addr}</Cell>
    }
