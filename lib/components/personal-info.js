...
class PersonalInfo extends Component {
  ...
  handleVehicle1PicChange(evt) {
    ...
    if (typeof onVehicle1PicChange == 'function') onVehicle1PicChange(evt.target.value)
  }
  ...
  handleVehicle2PicChange(evt) {
    ...
    if (typeof onVehicle2PicChange == 'function') onVehicle2PicChange(evt.target.value)
  }
  ...
  render() {
    ...
    const driverInfo = [
      <InputCell label='驾照号码' key='license_no'><input className='weui_input' onChange={this.handleLicenseNoChange.bind(this)} defaultValue={license_no}/></InputCell>,
      <UploadCell label='上传驾照照片' key='license_pic'>
        ...
        <div className='weui_uploader_input_wrp'>
          <input className='weui_uploader_input' type='file' accept='image/*' onChange={this.handleLicensePicChange.bind(this)} />
        </div>
      </UploadCell>,
      ...
      <UploadCell key='vehicle_1_pic' label='照片'>
        <ul className='weui_uploader_files'>{ vehicle_1_pic ? <li className='weui_upload_files' style={{backgroundImage: 'url(' + vehicle_1_pic + ')'}}></li> : '' }</ul>
        <div className='weui_uploader_input_wrp'>
    ...
    if (more_vehicle) {
      driverInfo.push(<InputCell key='vehicle_2_brand' label='品牌'><input className='weui_input' onChange={this.handleVehicle2BrandChange.bind(this)} defaultValue={vehicle_2_brand}/></InputCell>,
        ...
        <UploadCell key='vehicle_2_pic' label='照片'>
          <ul className='weui_uploader_files'>{ vehicle_2_pic ? <li className='weui_upload_files' style={{backgroundImage: 'url(' + vehicle_2_pic + ')'}}></li> : '' }</ul>
          <div className='weui_uploader_input_wrp'>
    ...
    return (
      <div className='weui_cells weui_cells_form'>
        <InputCell label='学校'><input className='weui_input' onChange={this.handleSchoolChange.bind(this)} defaultValue={school}/></InputCell>
        <InputCell label='姓名'><input className='weui_input' onChange={this.handleNameChange.bind(this)} defaultValue={name}/></InputCell>
        <InputCell label='昵称'><input className='weui_input' onChange={this.handleNickNameChange.bind(this)} defaultValue={nick_name}/></InputCell>
        <InputCell label='学校邮箱'><input className='weui_input' onChange={this.handleEmailChange.bind(this)} defaultValue={email}/></InputCell>
        <InputCell label='入学时间'><input className='weui_input' onChange={this.handleEnrollmentTChange.bind(this)} defaultValue={enrollment_t}/></InputCell>
