  ...
  render() {
    ...
    return (
      <div className='weui_cells weui_cells_form'>
        ...
        <InputCell label='学校邮箱'><input className='weui_input' onChange={this.handleEmailChange.bind(this)} defaultValue={email} type='email'/></InputCell>
        { password ? [
          <InputCell key='pwd' label='密码'><input className='weui_input' onChange={this.handlePwdChange.bind(this)} type='password' /></InputCell>,
          <InputCell key='pwd2' label='确认密码'><input className='weui_input' onChange={this.handlePwd2Change.bind(this)} type='password' /></InputCell>
        ] : '' }
        <InputCell label='入学时间'><input className='weui_input' onChange={this.handleEnrollmentTChange.bind(this)} defaultValue={enrollment_t} type='date'/></InputCell>
