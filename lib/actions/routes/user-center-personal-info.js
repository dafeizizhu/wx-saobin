...
export const REQUEST_GET_USER_INFO = 'ROUTES-USER_CENTER_PERSONAL_INFO-REQUEST_GET_USER_INFO'

export function requestGetUserInfo(params) {
  return {
...
export const RECIEVE_GET_USER_INFO = 'ROUTES-USER_CENTER_PERSONAL_INFO-RECIEVE_GET_USER_INFO'

export function recieveGetUserInfo(success, message, user_info) {
  return {
    type: RECIEVE_GET_USER_INFO,
    success,
    message,
    user_info
  }
...
export function fetchGetUserInfo(params) {
  return dispatch => {
    dispatch(requestGetUserInfo(params))
    getUserInfo(params, ret => {
      dispatch(recieveGetUserInfo(ret.error_code > 0, ret.msg, ret.data))
    })
  }
}
