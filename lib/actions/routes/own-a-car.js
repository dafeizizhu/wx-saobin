import { publishTravel, searchRequest } from '../../utils/cengceng-api' 
...
export const REQUEST_SEARCH = 'ROUTES-OWN_A_CAR-REQUEST_SEARCH'
...
export const RECIEVE_SEARCH = 'ROUTES-OWN_A_CAR-RECIEVE_SEARCH'
...
export function search(params) {
  return dispatch => {
    ...
    searchRequest(params, ret => {
      dispatch(recieveSearch(ret.error_code >= 0, ret.msg, ret.request_list))
      dispatch(push('/own-a-car/rs'))
    })
  }
}
